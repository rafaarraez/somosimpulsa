...
<html lang="en">
  <head>
    ...
    <title><?php echo $blogTulioTitulo; ?></title>
    ...
    <body>
        ...
        <header id="header-wrap">
            ...
            <div id="post-header" class="page-header">
				<div class="background-img" style="background-image: url('./src/Blog/miniatura.jpg');"></div>
				<div class="container">
					<div class="row">
						<div class="col-md-10">
							<div class="post-meta">
							...
							<h1><?php echo $blogTulioTitulo; ?> </h1>
						</div>
					</div>
				</div>
            </div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="section-row sticky-container text">
							<div class="main-post">
                                <h3><?php echo $blogTulioTitulo; ?></h3>
                                <div class="videoWrapper">
                                    <iframe width="560" height="315" src="https://www.youtube.com/embed/STb4nkppFfs" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                </div>
                                <?php echo $blogTulioContenido; ?>
                            </div>
